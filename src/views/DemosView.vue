<template>
  <div id="demo-page">
    <h1>🎯 Vue 3 Simple - 4 Personas</h1>
    
    <!-- Menú simple -->
    <div class="menu">
      <button @click="pagina = 'reactividad'" :class="{ active: pagina === 'reactividad' }">⚡ Reactividad</button>
      <button @click="pagina = 'composition'" :class="{ active: pagina === 'composition' }">🔧 Composition</button>
      <button @click="pagina = 'computed'" :class="{ active: pagina === 'computed' }">📊 Computed</button>
    </div>
    ...
    <div class="global">
      <h3>🌍 Estado Global (Persona 1)</h3>
      <p>Contador compartido: <strong>{{ global.contador }}</strong></p>
      <div class="controls">
...
const ReactividadDemo = defineAsyncComponent(() => import('../components/reactividad/ReactividadDemo.vue'))
const CompositionDemo = defineAsyncComponent(() => import('../components/composition/CompositionDemo.vue'))
...
.btn-plus { background: #42b883; color: white; }
